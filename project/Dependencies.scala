...
object Dependencies {
  ...
  val json4s =      Seq(libraryDependencies +=  "org.json4s" %% "json4s-native" % "3.2.5" % "compile")

  val akka =        Seq(libraryDependencies += "com.typesafe.akka" %% "akka-actor" % "2.1.4" % "compile",
    resolvers += "Typesafe Repository" at "http://repo.typesafe.com/typesafe/releases/")
    
  val spray =       Seq(libraryDependencies += "io.spray" % "spray-can" % "1.2-M8" % "compile", //2.9.3 ==1.0x 2.10 == 1.1x currently
